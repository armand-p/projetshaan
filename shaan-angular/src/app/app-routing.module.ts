...
const routes: Routes = [
  ...
  {path: ':joueurId/personnage', component: PersonnageComponent, canActivate: [AuthGuard]},
  {path: ':joueurId/personnage/:id', component: PersonnageComponent,canActivate: [AuthGuard]},
